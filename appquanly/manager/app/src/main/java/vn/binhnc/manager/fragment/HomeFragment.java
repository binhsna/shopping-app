...
import vn.binhnc.manager.activity.CategoryActivity;
import vn.binhnc.manager.activity.ChitietSanPhamActivity;
import vn.binhnc.manager.activity.MainActivity;
import vn.binhnc.manager.adapter.SanPhamAdapter;
import vn.binhnc.manager.adapter.BannerAdapter;
import vn.binhnc.manager.adapter.TheLoaiAdapter;
import vn.binhnc.manager.constant.Constant;
import vn.binhnc.manager.constant.GlobalFuntion;
import vn.binhnc.manager.databinding.FragmentHomeBinding;
...
public class HomeFragment extends BaseFragment {
    ...
    private void displayBanner() {
        BannerAdapter mBannerAdapter = new BannerAdapter(mListBanner, this::goToSanPhamDetail);
